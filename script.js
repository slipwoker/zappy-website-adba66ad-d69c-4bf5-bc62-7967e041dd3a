document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        successMessage.style.cssText = 'padding: 15px; margin: 15px 0; background: #4CAF50; color: white; border-radius: 4px;';
  ...
  function showError(input, message) {
    ...
    errorDiv.style.cssText = 'color: #f44336; font-size: 0.875rem; margin-top: 5px;';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Urban balcony משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'adba66ad-d69c-4bf5-bc62-7967e041dd3a',
                    name: data.name || '',
                    email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'adba66ad-d69c-4bf5-bc62-7967e041dd3a';
